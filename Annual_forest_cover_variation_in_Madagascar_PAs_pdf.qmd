...
tm_shape(contour_mada) +
  ...
  tm_credits("GADM, UNEP-WCMC and IUCN (2022)", position = c("RIGHT", "BOTTOM"),
             size = 0.6) +
  tm_layout(main.title = "Protected Areas of Madagascar",
...
**First limitation: missing data**. We can see that the information on protected areas creation dates, status and managing organization is often missing in WDPA.
